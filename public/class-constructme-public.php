...
class Constructme_Public {
    ...
    public function enqueue_styles() {
         ...
         * class.
         */
        wp_enqueue_style($this->plugin_name, plugin_dir_url(__FILE__) . 'css/constructme-public.css', array(), $this->version, 'all');
    }
    ...
    public function enqueue_scripts() {
        ...
        wp_register_script('constructme-rfq', plugins_url($this->plugin_name) . '/public/js/constructme-rfq.js', array(), $this->version, 'all');
